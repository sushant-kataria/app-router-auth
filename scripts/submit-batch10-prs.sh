...
#
# Targets (35–36 json.ts abandoned — maintainer closed as AI):
#   37) Avenx-JS/avenx-js#647 — document data-ax-class (merged #658)
#   38) Avenx-JS/avenx-js#638 — warn on multiple <state> tags (merged #659)
...
echo "==> Batch 10: avenx + sharibo only (json.ts abandoned — maintainer rejects AI PRs)"
